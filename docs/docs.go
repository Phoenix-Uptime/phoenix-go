...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/api_keys.APIKeyListResponse"
                        }
                    },
                    "400": {
                        "description": "invalid input",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_keys.CreateAPIKeyRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/api_keys.CreateAPIKeyResponse"
                        }
                    },
                    "400": {
                        "description": "invalid input",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "API key",
                        "schema": {
                            "$ref": "#/definitions/api_keys.APIKeyResponse"
                        }
                    },
                    "400": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_keys.UpdateAPIKeyRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/incidents.IncidentListResponse"
                        }
                    },
                    "400": {
                        "description": "invalid input",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/incidents.CreateIncidentRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/incidents.IncidentResponse"
                        }
                    },
                    "400": {
                        "description": "invalid input",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/incidents.UpdateIncidentRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/maintenance-windows": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "manual, single, recurring, or cron",
                        "name": "strategy",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/maintenance_windows.MaintenanceWindowListResponse"
                        }
                    },
                    "400": {
                        "description": "invalid input",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/maintenance_windows.CreateMaintenanceWindowRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/maintenance_windows.MaintenanceWindowResponse"
                        }
                    },
                    "400": {
                        "description": "invalid input",
        ...
        "/maintenance-windows/{id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "invalid maintenance window id",
                        "schema": {
                            "$ref": "#/definitions/routes.ErrorResponse"
                        }
                    },
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/maintenance_windows.UpdateMaintenanceWindowRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/maintenance-windows/{id}/activate": {
            "post": {
                "security": [
                    {
                        "ApiKeyHeader": []
        ...
        "/maintenance-windows/{id}/deactivate": {
            "post": {
                "security": [
                    {
                        "ApiKeyHeader": []
                ...
                "responses": {
                    "200": {
                        "description": "inactive maintenance window",
                        "schema": {
                            "$ref": "#/definitions/maintenance_windows.MaintenanceWindowResponse"
                        }
                    },
    ...
    "definitions": {
        ...
        "maintenance_windows.CreateMaintenanceWindowRequest": {
            "type": "object",
            "required": [
                "title"
            ],
        ...
        "maintenance_windows.MaintenanceWindowListResponse": {
            "type": "object",
            "properties": {
                "maintenance_windows": {
                    "type": "array",
        ...
        "maintenance_windows.MaintenanceWindowResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "maintenance_windows.UpdateMaintenanceWindowRequest": {
            "type": "object",
            "properties": {
                "cron": {
                    "type": "string"
