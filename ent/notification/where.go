...
func IsActive(v bool) predicate.Notification {
	return predicate.Notification(sql.FieldEQ(FieldIsActive, v))
}

// IsDefault applies equality check predicate on the "is_default" field. It's identical to IsDefaultEQ.
func IsDefault(v bool) predicate.Notification {
	return predicate.Notification(sql.FieldEQ(FieldIsDefault, v))
}
...
func IsActiveEQ(v bool) predicate.Notification {
	return predicate.Notification(sql.FieldEQ(FieldIsActive, v))
}

// IsActiveNEQ applies the NEQ predicate on the "is_active" field.
func IsActiveNEQ(v bool) predicate.Notification {
	return predicate.Notification(sql.FieldNEQ(FieldIsActive, v))
}

// IsDefaultEQ applies the EQ predicate on the "is_default" field.
func IsDefaultEQ(v bool) predicate.Notification {
	return predicate.Notification(sql.FieldEQ(FieldIsDefault, v))
}

// IsDefaultNEQ applies the NEQ predicate on the "is_default" field.
func IsDefaultNEQ(v bool) predicate.Notification {
	return predicate.Notification(sql.FieldNEQ(FieldIsDefault, v))
}

// ConfigIsNil applies the IsNil predicate on the "config" field.
func ConfigIsNil() predicate.Notification {
	return predicate.Notification(sql.FieldIsNull(FieldConfig))
}

// ConfigNotNil applies the NotNil predicate on the "config" field.
func ConfigNotNil() predicate.Notification {
	return predicate.Notification(sql.FieldNotNull(FieldConfig))
}
...
func HasMonitors() predicate.Notification {
	return predicate.Notification(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasMonitorsWith(preds ...predicate.Monitor) predicate.Notification {
	return predicate.Notification(func(s *sql.Selector) {
