...
func (_q *IncidentQuery) QueryMonitor() *MonitorQuery {
...
func (_q *IncidentQuery) QueryStatusPage() *StatusPageQuery {
...
func (_q *IncidentQuery) QueryResolvedBy() *UserQuery {
...
func (_q *IncidentQuery) QueryMessages() *StatusMessageQuery {
...
func (_q *IncidentQuery) WithMonitor(opts ...func(*MonitorQuery)) *IncidentQuery {
	query := (&MonitorClient{config: _q.config}).Query()
...
func (_q *IncidentQuery) WithStatusPage(opts ...func(*StatusPageQuery)) *IncidentQuery {
	query := (&StatusPageClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *IncidentQuery) WithResolvedBy(opts ...func(*UserQuery)) *IncidentQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *IncidentQuery) WithMessages(opts ...func(*StatusMessageQuery)) *IncidentQuery {
	query := (&StatusMessageClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *IncidentQuery) loadMonitor(ctx context.Context, query *MonitorQuery, nodes []*Incident, init func(*Incident), assign func(*Incident, *Monitor)) error {
...
func (_q *IncidentQuery) loadStatusPage(ctx context.Context, query *StatusPageQuery, nodes []*Incident, init func(*Incident), assign func(*Incident, *StatusPage)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Incident)
	for i := range nodes {
		if nodes[i].StatusPageID == nil {
			continue
		}
...
func (_q *IncidentQuery) loadResolvedBy(ctx context.Context, query *UserQuery, nodes []*Incident, init func(*Incident), assign func(*Incident, *User)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Incident)
	for i := range nodes {
...
func (_q *IncidentQuery) loadMessages(ctx context.Context, query *StatusMessageQuery, nodes []*Incident, init func(*Incident), assign func(*Incident, *StatusMessage)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(statusmessage.FieldIncidentID)
	}
...
func (_q *IncidentQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withMonitor != nil {
			_spec.Node.AddColumnOnce(incident.FieldMonitorID)
		}
		if _q.withStatusPage != nil {
			_spec.Node.AddColumnOnce(incident.FieldStatusPageID)
		}
		if _q.withResolvedBy != nil {
			_spec.Node.AddColumnOnce(incident.FieldResolvedByID)
		}
	}
